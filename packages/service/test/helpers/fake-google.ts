 ...
 *
 * Shared with @hebrew-dates/google-client's own tests, where it is the same
 * file. Duplicated rather than extracted into a package because a test double
 * that ships as a dependency invites being used in production code.
 *
